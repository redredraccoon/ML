...
#torch.save(model, f'model-best_train_acc.pth')
...
##    class_total = list(0. for i in enumerate(classes))
##
##    test_loss_list = [] # save loss for figure
##    test_acc_list = [] # save accuracy for figure
##    test_epoch_list = []
##	
##    with torch.no_grad():
...
##		train_acc_list.extend(training_acc)
